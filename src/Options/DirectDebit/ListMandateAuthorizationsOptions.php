...
class ListMandateAuthorizationsOptions extends OptionsAbstract
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->define('from')
            ->allowedTypes('string')
            ->info('A timestamp from which to start listing mandates e.g. 2016-09-24T00:00:05.000Z, 2016-09-21');

        $resolver->define('to')
            ->allowedTypes('string')
            ->info('A timestamp at which to stop listing mandates e.g. 2016-09-24T00:00:05.000Z, 2016-09-21');
    }
}